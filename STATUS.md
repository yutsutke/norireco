...
**`CACHE_VERSION = 'v326'`** · デプロイ回数 = バージョン番号の不変式
...
| **駅 id 体系 Phase 3 残り (LINES の id 付与)** | 📦 棚上げ — lines-p?.json の stations[] を直接参照する処理が現状なし。必要になってから再考 |
