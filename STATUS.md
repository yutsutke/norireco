...
**`CACHE_VERSION = 'v336'`** · デプロイ回数 = バージョン番号の不変式
...
| **Phase B: 関東主要 26 直通ペア (52 ref)** (v336) | ✅ 完成 — 9 グループ: 京急-浅草-京成-北総 (5) / 副都心+東横+みなとみらい (4) / 有楽町線 (2) / 西武 (1) / 半蔵門 (2) / 千代田 (2) / 東西 (2) / 目黒-南北-三田-埼玉高速-相鉄 (6) / 埼京-りんかい-川越 (2)。through_lines 持ち系統 14→40。`tools/add_kanto_through_lines.js` 新規 (冪等 + 双方向 + broken refs 0 assert)。「ハブ navigable」モデル踏襲。CHANGELOG §186 |
