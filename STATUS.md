...
**`CACHE_VERSION = 'v436'`** · デプロイ回数 = バージョン番号の不変式 (v436 シェア受け側 /share の強化 + view/click 計測 ※ v436_share_metrics.sql 要 Run)
