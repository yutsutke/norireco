...
**`CACHE_VERSION = 'v338'`** · デプロイ回数 = バージョン番号の不変式
...
| カテゴリ | カバー状況 |
|---|---|
| 営業系統 | 640 + α 系統 (v334 で青梅線・大和路線・阪和線 を手動キュレーション化) |
