...
**`CACHE_VERSION = 'v435'`** · デプロイ回数 = バージョン番号の不変式 (v435 環状線「17/30」は解消済みと判明・偽の注意書き撤去)
