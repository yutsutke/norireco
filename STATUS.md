...
**`CACHE_VERSION = 'v316'`** · デプロイ回数 = バージョン番号の不変式
...
| **駅 id 体系 Phase 3 残り (マイページ駅名検索 id 解決層 + slVisitCount を SERVICE_LINES ベース化 + name 列廃止)** | ❌ 未着手 |
