...
- [ ] **直通系統の追加**（service_lines_master.json の `through_lines`）
  ...
  - **v336**: Phase B 関東 26 直通ペア / 52 ref (京急-浅草-京成-北総 / 副都心+東横+みなとみらい / 有楽町 / 西武 / 半蔵門 / 千代田 / 東西 / 目黒-南北-三田-埼玉高速-相鉄 / 埼京-りんかい-川越) 完了
  - 残 (Phase C 関西):
    - 阪急京都線↔大阪メトロ堺筋線 (天神橋筋六丁目)
    - 阪神なんば線↔近鉄奈良線 (大阪難波)
    - 阪急神戸高速線/阪神神戸高速線/神戸電鉄神戸高速線 (新開地)
    - 京阪本線↔京阪鴨東線 (出町柳側) 京阪内
    - 阪急京都線↔阪急千里線 (淡路) 阪急内
    - 近鉄京都線↔近鉄橿原線 (大和西大寺) 等
  - その他散発: F ライナー以外の関東残り (相鉄↔JR埼京/直通)、北陸新幹線↔IRいしかわ/あいの風 (JR第三セクター接続)
