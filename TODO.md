...
- [ ] **Notion 子ページの中抜けバージョン補完（v132〜v189）— 残りスコープ**
  - 2026-05-18 セッションで棚卸し完了 + P0/P1/P2/P3 を消化:
    ...
    - ✅ **2.3 ⚡ SW/PWA**: CACHE_VERSION を v157 → v189 に更新、v158〜v189 セクション追加
    - ✅ **2.4 📁 コード構成**: v158-172 LOD / v174 期間フィルタ / v175-176 用語統一 / v177 マップ表示モード / v178-180 記憶精度 / v181-185 メモ・遅延 / v186 stop_type / v187-189 駅フィルタ集約 を反映
  - **残り（次セッション以降）**:
