...
- [ ] **Notion 子ページの中抜けバージョン補完（v132〜v189）— 残りスコープ**
  - 2026-05-18 セッションで棚卸し完了 + P0/P1 を消化:
    - ✅ **1.3 📝 記録モード**: v133/v134/v135-137/v144/v175/v176/v178/v179/v180/v186 を「バージョン履歴」に追記
    - ✅ **1.4 👤 マイページ**: v174/v175/v178/v179 を「バージョン履歴」に追記
  - **残り（次セッション以降）**:
    - **1.2 🗾 地図画面**: v173 データ補修 / v174「〜月指定」/ v177 マップ表示モード（個別節として詳細化）
    - **2.1 🗂 データアーキテクチャ**: v157 setDateFilter連動 / v174 期間フィルタ拡張 / v178/v179 date_precision 5値化 / v181 notes/delay_minutes（schema 未拡張） / v186 stop_type 自動派生
    - **2.2 🗄 Supabase**: v178/v179 date_precision 拡張 / v181/v185 notes/delay_minutes workaround
    ...
    - **2.6 🔀 データの流れ**: v174 期間フィルタ / v179 date_precision / v186 stop_type 派生フロー / タイムマシン廃止反映（フロー D）
