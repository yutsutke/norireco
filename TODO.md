...
**現在の SW**: v158 / **キャラ**: 7体（八王子3・立川3・小宮1）
**列車マスター**: 約260種（新幹線19・特急90+・寝台18・クルーズ3・観光列車60+・SL9・急行18、戦前〜現代まで）
**コード構成**: `js/01-..〜14-..` 機能別分割（v131〜v158、`HANDOFF.md §20, §21, §22` 参照）
...
- [x] ~~**マップ LOD 整理 + 都道府県ヒートマップ**~~ → **✅ v158 完成** (Notion 仕様、HANDOFF §22)
  - Task 1 LOD 閾値 / Task 2 ヒートマップ / Task 3 tier 基準サイズ / Task 4 1路線駅 circleMarker / Task 5 Lv4 ハロー toggle / Task 6 路線色 zoom 連動
  - 残: 路線 weight の zoom 連動 (現在は visibility filter のみ)、ヒートマップを point-in-polygon に置き換えて県境精度向上
