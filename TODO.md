...
- [ ] **一括記録 (まとめて記録)** (Notion §1.3 設計確定 / B カテゴリ完結 v392-v399 / **A 段階 A-1〜A-8 完結 v400-v406** = 全機能 + 区間ピッカー / **v407 で旧 `noritetsu-log.html` 削除完了** = 受け皿として完全置換、**写真添付 ✅ v434** / 残: ① 環状線対応 (山手線 17/30 駅塗り、`resolveByServiceLine` の複数 N02 線レンジ詰め問題) ／ ③ 複数 segment = 設計上スキップ推奨 (手動記録 07 で代替))
  - **動機 2 層**:
