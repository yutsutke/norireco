# 乗レコ - 電車旅 更新履歴 (Phase 1〜3.7 アーカイブ)

`CHANGELOG.md` から退避した Phase 1〜3.7 (v60〜v157 相当, §1〜§21) のセッションログ。
現行 Phase 3.8 以降の履歴は [CHANGELOG.md](CHANGELOG.md) を参照。

カバー範囲:
- §1〜§14: プロジェクト概要・技術スタック・初期セッション (Phase 1〜2 narrative)
- §15〜§18: セッション 3〜3.5 (Phase 2〜3.5, v70〜v108)
- §19: セッション 3.6 (v109〜v131) — GPS 安定化・列車種別・コード分割
- §20: ファイル構成 (v131 時点のスナップショット)
- §21: セッション 3.7 (v132〜v157) — Supabase 認証・マイページ・不正検知
