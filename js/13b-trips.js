...
// v398 (B-4-a): 旧 13b dead 関数群 (applyTripEditCategoryVisibility / populateTripEditTrainDropdown /
//   onTripEditCategoryChange / applyTripEditSegCategoryVisibility / populateTripEditSegCarSelect /
//   restoreTripEditSegCascade / onTripEditSegCategoryChange / onTripEditSegTrainChange /
//   onTripEditSegCarChange / onTripEditTrainChange) を全削除 (264 行)。
//   factory `createTripDetailEditor` (per-seg-rows / trip-level mode) が完全に置き換え (v393 B-2)。
//   旧 HTML input (#trip-edit-train-category / -id / -name / car-model / -date / -depart / -arrive /
//   -time-lock / -time-inputs / -delay-h / -delay-m / -notes) も noritetsu-map.html から撤去済。
